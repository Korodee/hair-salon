...
export default function Profile() {
    ...
    useEffect(() => {
        ...
        checkAuth();
    }, [router]); // Only trigger on mount, no need for checkAuth in the dependency array
            ...
            <div className="text-black/80 ">
                ...
                <div className="mb-6 mx-2 ">
                    <div className="flex justify-between">
                        ...
                        <div>
                            ...
                            <p className="text-gray-700 text-sm">
                                Track your reward points to unlock exclusive
                                benefits!
                            </p>
                        </div>
                    </div>
                ...
                <div className="mx-2 md:flex justify-between items-center">
                    ...
                    <button
                        ...
                        onClick={() =>
                            router.push("/auth/login/recover-password")
                        }
                    >
                        Change Password
                    </button>
