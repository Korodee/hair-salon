...
export default function Dashboard() {
    ...
    const [allBookedDates, setAllBookedDates] = useState<string[]>([]); // State for all booked dates
            ...
            <div className="md:flex md:space-x-2 my-3 space-y-4 md:space-y-0 justify-between">
                <div className="md:w-2/3">
                    ...
                    <p className="text-gray-500 pb-4">
                        This calendar shows available dates and times for
                        appointments.
                    </p>
                    <div className="rounded-2xl px-4">
                        ...
                        <div className="grid grid-cols-7 gap-2">
                            {Array.from({
                                ...
                                // Check if the date is booked (either by the user or generally)
                                const isBooked =
                                    allBookedDates.includes(dateKey); // Use allBookedDates here

                                const isUserBookedDate =
                                    userBookedDates.includes(dateKey);
                                ...
                                return (
                                    <button
                                        ...
                                        disabled={day < today || isBooked} // Disable if booked
                                        ...
                                        className={`p-3 rounded-lg transition ${
                                            !isSameMonth(day, currentMonth)
                                                ...
                                                : isBooked
                                                ? "bg-red-500 text-white" // Red for booked dates
